...
func (c *Client) AccountChangeAuthorizationSettings(hash int64, encryptedRequestsDisabled, callRequestsDisabled bool) (bool, error) {
...
func (c *Client) AccountDeclinePasswordReset() (bool, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "sending AccountDeclinePasswordReset")
	}
...
func (c *Client) AccountReportProfilePhoto(peer InputPeer, photoID InputPhoto, reason ReportReason, message string) (bool, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "sending AccountReportProfilePhoto")
	}
...
func (c *Client) AccountSetAuthorizationTtl(authorizationTtlDays int32) (bool, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "sending AccountSetAuthorizationTtl")
	}
...
func (c *Client) AuthCheckRecoveryPassword(code string) (bool, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "sending AuthCheckRecoveryPassword")
	}
...
func (c *Client) BotsResetBotCommands(scope BotCommandScope, langCode string) (bool, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "sending BotsResetBotCommands")
	}
...
func (c *Client) ChannelsViewSponsoredMessage(channel InputChannel, randomID []byte) (bool, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "sending ChannelsViewSponsoredMessage")
	}
...
func (c *Client) MessagesDeleteChat(chatID int64) (bool, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "sending MessagesDeleteChat")
	}
...
func (c *Client) MessagesDeleteExportedChatInvite(peer InputPeer, link string) (bool, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "sending MessagesDeleteExportedChatInvite")
	}
...
func (c *Client) MessagesDeleteRevokedExportedChatInvites(peer InputPeer, adminID InputUser) (bool, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "sending MessagesDeleteRevokedExportedChatInvites")
	}
...
func (c *Client) MessagesExportChatInvite(params *MessagesExportChatInviteParams) (*ChatInviteExported, error) {
	responseData, err := c.MakeRequest(params)
	if err != nil {
...
func (c *Client) MessagesGetSearchResultsCalendar(peer InputPeer, filter MessagesFilter, offsetID, offsetDate int32) (*MessagesSearchResultsCalendar, error) {
	responseData, err := c.MakeRequest(&MessagesGetSearchResultsCalendarParams{
		Filter:     filter,
...
func (c *Client) MessagesGetSearchResultsPositions(peer InputPeer, filter MessagesFilter, offsetID, limit int32) (*MessagesSearchResultsPositions, error) {
	responseData, err := c.MakeRequest(&MessagesGetSearchResultsPositionsParams{
		Filter:   filter,
		Limit:    limit,
		OffsetID: offsetID,
		Peer:     peer,
...
func (c *Client) MessagesSaveDefaultSendAs(peer, sendAs InputPeer) (bool, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "sending MessagesSaveDefaultSendAs")
	}
...
func (c *Client) MessagesSetDefaultReaction(reaction string) (bool, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "sending MessagesSetDefaultReaction")
	}
...
func (c *Client) MessagesStartHistoryImport(peer InputPeer, importID int64) (bool, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "sending MessagesStartHistoryImport")
	}
...
func (c *Client) MessagesTranslateText(params *MessagesTranslateTextParams) (MessagesTranslatedText, error) {
	responseData, err := c.MakeRequest(params)
	if err != nil {
		return nil, errors.Wrap(err, "sending MessagesTranslateText")
	}

	resp, ok := responseData.(MessagesTranslatedText)
	if !ok {
		panic("got invalid response type: " + reflect.TypeOf(responseData).String())
	}
	return resp, nil
...
func (c *Client) PhoneSaveDefaultGroupCallJoinAs(peer, joinAs InputPeer) (bool, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "sending PhoneSaveDefaultGroupCallJoinAs")
	}
...
func (c *Client) StickersCheckShortName(shortName string) (bool, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "sending StickersCheckShortName")
	}
