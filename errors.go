...
var errorMessages = map[string]string{
	...
	"AUDIO_TITLE_INVALID":                 "The title of the audio is invalid",
	...
	"STICKER_TGS_NODOC":                   "Stickers must be a tgs file but the used file was not a tgs",
	"STICKER_TGS_NOTGS":                   "The provided file is not a tgs file",
	"STICKER_VIDEO_BIG":                   "The provided video sticker is too big",
