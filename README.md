...
[![license MIT](https://img.shields.io/badge/license-MIT-green)](https://github.com/amarnathcjd/gogramblob/main/README.md)
...
**english** [русский](https://github.com/amarnathcjd/gogramblob/main/docs/ru_RU/README.md) [简体中文](https://github.com/amarnathcjd/gogramblob/main/docs/zh_CN/README.md)
...
**Code examples are [here](https://github.com/amarnathcjd/gogramblob/main/examples)**
...
**Example [here](https://github.com/amarnathcjd/gogramblob/main/examples/auth)**
...
Want to deal those freaky `tg://` links? See [`deeplinks` package](https://github.com/amarnathcjd/gogramblob/main/telegram/deeplinks), here is the simplest how-to:
...
import (
    ...
    "github.com/amarnathcjd/gogramtelegram/deeplinks"
)
...
Please read [contributing guide](https://github.com/amarnathcjd/gogramblob/main/.github/CONTRIBUTING.md) if you want to help. And the help is very necessary!

**Don't want code?** Read [this](https://github.com/amarnathcjd/gogramblob/main/.github/SUPPORT.md) page! We love nocoders!

## Security bugs?

Please, don't create issue which describes security bug, this can be too offensive! Instead, please read [this notification](https://github.com/amarnathcjd/gogramblob/main/.github/SECURITY.md) and follow that steps to notify us about problem.
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/amarnathcjd/gogramblob/main/LICENSE.md) file for details
